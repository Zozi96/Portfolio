...
export function SpotlightCard({
  ...
  return (
    <motion.div
      ...
      className={`group relative glass-panel rounded-2xl overflow-hidden transition-all duration-500 hover:shadow-xl dark:hover:shadow-2xl hover:-translate-y-1 ${className}`}
    >
      <div
