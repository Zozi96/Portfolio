...
import { Home, FolderGit2, Briefcase, Mail, Menu } from "lucide-react";
        ...
        <AnimatePresence mode="wait">
          {isCollapsed ? (
            <motion.button
              ...
              className="flex items-center justify-center min-w-[44px] min-h-[44px] px-3 py-2 rounded-full text-zinc-500 dark:text-zinc-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors touch-manipulation"
